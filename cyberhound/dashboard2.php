...
<form action='expand.php' method='get' class='form-inline col-md-12'>
    <input type='text' class='form-control col-md-4' name='ven' placeholder='Manufacturer Name'>
    <input type='text' class='form-control col-md-4' name='dev' placeholder='Device Name'>
    <input type='submit' class='btn btn-primary col-md-4' name='search' value='Search'>
</form><br><hr>
</div>
</div>
</div>
